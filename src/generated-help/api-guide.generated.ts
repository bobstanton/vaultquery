...
export function render(container: HTMLElement, ctx: RenderContext): void {
  ...
  td31.createEl('code', { cls: 'vaultquery-help-code', text: "indexing.unresolvedLinks" });
  const td32 = row22.createEl('td');
  td32.createEl('code', { cls: 'vaultquery-help-code', text: "unresolved_links" });
  td32.appendText(" table is available");
  const row23 = tbody1.createEl('tr');
  const td33 = row23.createEl('td');
  td33.createEl('code', { cls: 'vaultquery-help-code', text: "indexing.embeds" });
  const td34 = row23.createEl('td');
  td34.createEl('code', { cls: 'vaultquery-help-code', text: "embeds" });
  td34.appendText(" table is available");
  const row24 = tbody1.createEl('tr');
  const td35 = row24.createEl('td');
  td35.createEl('code', { cls: 'vaultquery-help-code', text: "indexing.tags" });
  const td36 = row24.createEl('td');
  td36.createEl('code', { cls: 'vaultquery-help-code', text: "tags" });
  td36.appendText(" table is available");
  const row25 = tbody1.createEl('tr');
  const td37 = row25.createEl('td');
  td37.createEl('code', { cls: 'vaultquery-help-code', text: "indexing.blocks" });
  const td38 = row25.createEl('td');
  td38.createEl('code', { cls: 'vaultquery-help-code', text: "blocks" });
  td38.appendText(" table is available");
  const row26 = tbody1.createEl('tr');
  const td39 = row26.createEl('td');
  td39.createEl('code', { cls: 'vaultquery-help-code', text: "indexing.listItems" });
  const td40 = row26.createEl('td');
  td40.createEl('code', { cls: 'vaultquery-help-code', text: "list_items" });
  td40.appendText(" table is available");
  ...
  const row27 = thead2.createEl('tr');
  row27.createEl('th', { text: "Variable" });
  ...
  td41.createEl('code', { cls: 'vaultquery-help-code', text: "{this.path}" });
  row28.createEl('td', { text: "Full file path" });
  const row29 = tbody2.createEl('tr');
  const td42 = row29.createEl('td');
  td42.createEl('code', { cls: 'vaultquery-help-code', text: "{this.name}" });
  row29.createEl('td', { text: "Filename with extension" });
  const row30 = tbody2.createEl('tr');
  const td43 = row30.createEl('td');
  td43.createEl('code', { cls: 'vaultquery-help-code', text: "{this.basename}" });
  row30.createEl('td', { text: "Filename without extension" });
  const row31 = tbody2.createEl('tr');
  const td44 = row31.createEl('td');
  td44.createEl('code', { cls: 'vaultquery-help-code', text: "{this.extension}" });
  row31.createEl('td', { text: "File extension" });
  const row32 = tbody2.createEl('tr');
  const td45 = row32.createEl('td');
  td45.createEl('code', { cls: 'vaultquery-help-code', text: "{this.folder}" });
  row32.createEl('td', { text: "Parent folder path" });
  const row33 = tbody2.createEl('tr');
  const td46 = row33.createEl('td');
  td46.createEl('code', { cls: 'vaultquery-help-code', text: "{this.created}" });
  row33.createEl('td', { text: "Creation timestamp (ms)" });
  const row34 = tbody2.createEl('tr');
  const td47 = row34.createEl('td');
  td47.createEl('code', { cls: 'vaultquery-help-code', text: "{this.modified}" });
  row34.createEl('td', { text: "Modified timestamp (ms)" });
  const row35 = tbody2.createEl('tr');
  const td48 = row35.createEl('td');
  td48.createEl('code', { cls: 'vaultquery-help-code', text: "{this.size}" });
  row35.createEl('td', { text: "File size in bytes" });
  const row36 = tbody2.createEl('tr');
  const td49 = row36.createEl('td');
  td49.createEl('code', { cls: 'vaultquery-help-code', text: "{this.frontmatter.key}" });
  row36.createEl('td', { text: "Frontmatter property value" });
