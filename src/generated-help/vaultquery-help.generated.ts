...
export function render(container: HTMLElement, ctx: RenderContext): void {
  ...
  if (typeof Prism !== 'undefined' && Prism.languages["vaultquery"]) {
    codeBlock33Code.innerHTML = Prism.highlight("SELECT title, path, modified\nFROM notes\nORDER BY modified DESC\nLIMIT 20;\n\nconfig:\nheight: 320px", Prism.languages["vaultquery"], "vaultquery");
  } else {
    codeBlock33Code.textContent = "SELECT title, path, modified\nFROM notes\nORDER BY modified DESC\nLIMIT 20;\n\nconfig:\nheight: 320px";
  }
  ...
  if (typeof Prism !== 'undefined' && Prism.languages["vaultquery-markdown"]) {
    codeBlock34Code.innerHTML = Prism.highlight("SELECT title, path, modified\nFROM notes\nORDER BY modified DESC\nLIMIT 10;", Prism.languages["vaultquery-markdown"], "vaultquery-markdown");
  } else {
    codeBlock34Code.textContent = "SELECT title, path, modified\nFROM notes\nORDER BY modified DESC\nLIMIT 10;";
  }
  ...
  if (typeof Prism !== 'undefined' && Prism.languages["vaultquery-markdown"]) {
    codeBlock35Code.innerHTML = Prism.highlight("SELECT title, size\nFROM notes\nORDER BY size DESC\nLIMIT 10;\n\nconfig:\ncolumns: title, size\nalignment: left, right", Prism.languages["vaultquery-markdown"], "vaultquery-markdown");
  } else {
    codeBlock35Code.textContent = "SELECT title, size\nFROM notes\nORDER BY size DESC\nLIMIT 10;\n\nconfig:\ncolumns: title, size\nalignment: left, right";
  }
  ...
  if (typeof Prism !== 'undefined' && Prism.languages["vaultquery"]) {
    codeBlock37Code.innerHTML = Prism.highlight("SELECT path, title, status FROM notes_with_properties WHERE status = 'active'", Prism.languages["vaultquery"], "vaultquery");
  } else {
    codeBlock37Code.textContent = "SELECT path, title, status FROM notes_with_properties WHERE status = 'active'";
  }
  ...
  if (typeof Prism !== 'undefined' && Prism.languages["vaultquery"]) {
    codeBlock38Code.innerHTML = Prism.highlight("SELECT n.path, n.title, p.value as status\nFROM notes n\nJOIN properties p ON n.path = p.path AND p.key = 'status'\nWHERE p.value = 'active'", Prism.languages["vaultquery"], "vaultquery");
  } else {
    codeBlock38Code.textContent = "SELECT n.path, n.title, p.value as status\nFROM notes n\nJOIN properties p ON n.path = p.path AND p.key = 'status'\nWHERE p.value = 'active'";
  }
  ...
  const codeBlock39Code = codeBlock39.createEl('code');
  if (typeof Prism !== 'undefined' && Prism.languages["vaultquery"]) {
    codeBlock39Code.innerHTML = Prism.highlight("-- Instead of: WHERE path IN (SELECT path FROM tags WHERE tag_name = '#project')\nSELECT * FROM notes n\nWHERE EXISTS (SELECT 1 FROM tags t WHERE t.path = n.path AND t.tag_name = '#project')", Prism.languages["vaultquery"], "vaultquery");
  } else {
    codeBlock39Code.textContent = "-- Instead of: WHERE path IN (SELECT path FROM tags WHERE tag_name = '#project')\nSELECT * FROM notes n\nWHERE EXISTS (SELECT 1 FROM tags t WHERE t.path = n.path AND t.tag_name = '#project')";
  }
  ...
  const codeBlock40Code = codeBlock40.createEl('code');
  if (typeof Prism !== 'undefined' && Prism.languages["vaultquery"]) {
    codeBlock40Code.innerHTML = Prism.highlight("SELECT title, path FROM notes LIMIT 5;\ntemplate:\nreturn `<ul>\n  ${results.map(r => `<li>${h.link(r.path, r.title)}</li>`).join('')}\n</ul>`", Prism.languages["vaultquery"], "vaultquery");
  } else {
    codeBlock40Code.textContent = "SELECT title, path FROM notes LIMIT 5;\ntemplate:\nreturn `<ul>\n  ${results.map(r => `<li>${h.link(r.path, r.title)}</li>`).join('')}\n</ul>`";
  }
  ...
  const codeBlock41Code = codeBlock41.createEl('code');
  if (typeof Prism !== 'undefined' && Prism.languages["vaultquery"]) {
    codeBlock41Code.innerHTML = Prism.highlight("SELECT title, path, content FROM notes WHERE content IS NOT NULL LIMIT 3;\ntemplate:\nreturn `<div style=\"display: grid; gap: 1em;\">\n  ${results.map(r => `\n    <div style=\"border: 1px solid var(--background-modifier-border); padding: 1em; border-radius: 8px;\">\n      <h4>${h.link(r.path, r.title)}</h4>\n      <p>${h.truncate(h.escape(r.content), 100)}</p>\n    </div>\n  `).join('')}\n</div>`", Prism.languages["vaultquery"], "vaultquery");
  } else {
    codeBlock41Code.textContent = "SELECT title, path, content FROM notes WHERE content IS NOT NULL LIMIT 3;\ntemplate:\nreturn `<div style=\"display: grid; gap: 1em;\">\n  ${results.map(r => `\n    <div style=\"border: 1px solid var(--background-modifier-border); padding: 1em; border-radius: 8px;\">\n      <h4>${h.link(r.path, r.title)}</h4>\n      <p>${h.truncate(h.escape(r.content), 100)}</p>\n    </div>\n  `).join('')}\n</div>`";
  }
  ...
  const codeBlock42Code = codeBlock42.createEl('code');
  if (typeof Prism !== 'undefined' && Prism.languages["vaultquery"]) {
    codeBlock42Code.innerHTML = Prism.highlight("SELECT status, COUNT(*) as cnt FROM tasks GROUP BY status;\ntemplate:\nreturn `<p>Found ${count} status types:</p>\n<ul>\n  ${results.map(r => `<li><strong>${h.escape(r.status)}</strong>: ${r.cnt} tasks</li>`).join('')}\n</ul>`", Prism.languages["vaultquery"], "vaultquery");
  } else {
    codeBlock42Code.textContent = "SELECT status, COUNT(*) as cnt FROM tasks GROUP BY status;\ntemplate:\nreturn `<p>Found ${count} status types:</p>\n<ul>\n  ${results.map(r => `<li><strong>${h.escape(r.status)}</strong>: ${r.cnt} tasks</li>`).join('')}\n</ul>`";
  }
