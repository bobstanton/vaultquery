...
export function render(container: HTMLElement, ctx: RenderContext): void {
  ...
  para9.appendText("Using the ");
  para9.createEl('code', { cls: 'vaultquery-help-code', text: "notes_with_properties" });
  para9.appendText(" view (pivots property rows to columns):");
  ...
  renderPrismCode(code4, "SELECT path, title, status, priority\nFROM notes_with_properties\nWHERE status IS NOT NULL\nORDER BY path;", "vaultquery");
  ...
  para10.appendText("Or using a JOIN with the ");
  para10.createEl('code', { cls: 'vaultquery-help-code', text: "properties" });
  para10.appendText(" table:");
  ...
  para11.appendText("Or using the ");
  para11.createEl('code', { cls: 'vaultquery-help-code', text: "note_properties" });
  para11.appendText(" view (properties only, no notes columns):");
  ...
  renderPrismCode(code6, "SELECT path, status, priority\nFROM note_properties\nWHERE status IS NOT NULL\nORDER BY path;", "vaultquery");
  ...
  renderPrismCode(code7, "SELECT path, level, heading_text\nFROM headings\nWHERE path = '{this.path}'\nORDER BY line_number;", "vaultquery");
  ...
  renderPrismCode(code8, "SELECT content, indent_level, list_type\nFROM list_items\nWHERE path = '{this.path}'\nORDER BY item_index;", "vaultquery");
  ...
  para12.appendText("The ");
  para12.createEl('code', { cls: 'vaultquery-help-code', text: "list_items_view" });
  para12.appendText(" includes a computed ");
  para12.createEl('code', { cls: 'vaultquery-help-code', text: "parent_content" });
  para12.appendText(" column showing the parent item's text:");
  ...
  renderPrismCode(code9, "SELECT content, indent_level, parent_content\nFROM list_items_view\nWHERE path = '{this.path}'\nORDER BY item_index;", "vaultquery");
  ...
  renderPrismCode(code10, "SELECT path, task_text, status, priority\nFROM tasks\nWHERE status != 'DONE'\nORDER BY priority DESC;", "vaultquery");
  ...
  para13.createEl('code', { cls: 'vaultquery-help-code', text: "tasks_view" });
  para13.appendText(" includes computed columns for easier sorting and filtering:");
  ...
  const para14 = content.createEl('p', { cls: 'vaultquery-help-paragraph' });
  para14.appendText("Prefer using views (when present) over the underlying tables - the views provide defaults when inserting new records:");
  ...
  para15.appendText("Using the ");
  para15.createEl('code', { cls: 'vaultquery-help-code', text: "table_rows" });
  para15.appendText(" view (data as JSON objects):");
  ...
  renderPrismCode(code12, "SELECT path, table_index, row_index, row_json\nFROM table_rows\nWHERE path = '{this.path}'\nORDER BY table_index, row_index;", "vaultquery");
  ...
  para16.appendText("Or using dynamic table views (like ");
  para16.createEl('code', { cls: 'vaultquery-help-code', text: "budgets_table" });
  para16.appendText(", requires setting):");
  ...
  renderPrismCode(code13, "SELECT path, table_index, row_index, Category, Amount\nFROM budgets_table\nWHERE path = '{this.path}'\nORDER BY table_index, row_index;", "vaultquery");
  ...
  para17.appendText("Or using the ");
  para17.createEl('code', { cls: 'vaultquery-help-code', text: "table_cells" });
  para17.appendText(" table directly:");
  ...
  renderPrismCode(code14, "SELECT path, table_index, row_index, column_name, cell_value\nFROM table_cells\nWHERE path = '{this.path}'\nORDER BY table_index, row_index, column_name;", "vaultquery");
  ...
  para18.appendText("Use ");
  para18.createEl('code', { cls: 'vaultquery-help-code', text: "vaultquery-view" });
  para18.appendText(" blocks to create SQL views that can be queried from any note.");
  ...
  para19.appendText("Once created, query the view like any table:");
  ...
  renderPrismCode(code16, "SELECT * FROM recent_notes WHERE title LIKE '%project%'", "vaultquery");
  ...
  const para20 = content1.createEl('p', { cls: 'vaultquery-help-paragraph' });
  para20.appendText("Views show a preview when created. Configure preview row limit in settings (default: 10 rows, set to 0 to disable).");
  ...
  para21.appendText("VaultQuery includes built-in SQL functions (regex, date, link building, link resolution, path, geolocation) and supports user-defined functions in JavaScript.");
  const para22 = container.createEl('p', { cls: 'vaultquery-help-paragraph' });
  para22.appendText("Use a ");
  para22.createEl('code', { cls: 'vaultquery-help-code', text: "vaultquery-function-help" });
  para22.appendText(" code block for complete function documentation:");
  ...
  para23.appendText("Use CTEs (Common Table Expressions) to create a new daily note and migrate incomplete tasks from the previous day's note. The query finds the most recent daily note before today (not necessarily yesterday) and carries forward any unfinished tasks.");
  ...
  para24.appendText("After creating the new note, optionally mark the original tasks as complete:");
  ...
  para25.appendText("Inline buttons use the syntax ");
  para25.appendText("`");
  para25.createEl('code', { cls: 'vaultquery-help-code', text: "vq[Label]{SQL}" });
  para25.appendText("`");
  para25.appendText(" to execute SQL with a single click. Requires \"Enable inline buttons\" in settings.");
  ...
  para26.appendText("The related ");
  para26.appendText("`");
  para26.createEl('code', { cls: 'vaultquery-help-code', text: "vq{SELECT ...}" });
  para26.appendText("`");
  para26.appendText(" syntax is not a button. It is an inline query value; see the next section.");
  ...
  para29.appendText("Inline query values use the syntax ");
  para29.appendText("`");
  para29.createEl('code', { cls: 'vaultquery-help-code', text: "vq{SELECT ...}" });
  para29.createEl('code', { cls: 'vaultquery-help-code', text: " inside inline code and render the first column of the first row directly in the surrounding text. Inline query values are read-only and only allow " });
  para29.appendText("SELECT");
  para29.createEl('code', { cls: 'vaultquery-help-code', text: " or " });
  para29.appendText("WITH");
  para29.appendText("`");
  para29.appendText(" statements.");
  const codeBlock30 = container.createDiv();
  void MarkdownRenderer.render(ctx.app, "```\nThe hike was `vq{SELECT value FROM properties WHERE key = 'distance' AND path = '{this.path}' LIMIT 1}` miles.\n```", codeBlock30, '', ctx.component);
  ...
  para30.appendText("When enabled in VaultQuery settings, ");
  para30.createEl('code', { cls: 'vaultquery-help-code', text: "vaultquery:query" });
  para30.appendText(" runs SQL from the Obsidian CLI and waits for indexing to finish before executing.");
  const codeBlock31 = container.createDiv();
  void MarkdownRenderer.render(ctx.app, "```\nobsidian vaultquery:query sql=\"SELECT title, path FROM notes LIMIT 5\" format=json\n```", codeBlock31, '', ctx.component);
  const para31 = container.createEl('p', { cls: 'vaultquery-help-paragraph' });
  para31.appendText("Available formats are ");
  para31.createEl('code', { cls: 'vaultquery-help-code', text: "json" });
  para31.appendText(", ");
  para31.createEl('code', { cls: 'vaultquery-help-code', text: "csv" });
  para31.appendText(", ");
  para31.createEl('code', { cls: 'vaultquery-help-code', text: "tsv" });
  para31.appendText(", ");
  para31.createEl('code', { cls: 'vaultquery-help-code', text: "md" });
  para31.appendText(", and ");
  para31.createEl('code', { cls: 'vaultquery-help-code', text: "scalar" });
  para31.appendText(". Use ");
  para31.createEl('code', { cls: 'vaultquery-help-code', text: "path" });
  para31.appendText(" to provide note context for ");
  para31.createEl('code', { cls: 'vaultquery-help-code', text: "{this.*}" });
  para31.appendText(" placeholders.");
  ...
  para32.createEl('code', { cls: 'vaultquery-help-code', text: "INSERT" });
  para32.appendText(", ");
  para32.createEl('code', { cls: 'vaultquery-help-code', text: "UPDATE" });
  para32.appendText(", and ");
  para32.createEl('code', { cls: 'vaultquery-help-code', text: "DELETE" });
  para32.appendText(" require both write operations and CLI write operations to be enabled in settings.");
  ...
  para33.appendText("Use the output-specific fence name to choose a renderer. That makes help discoverable by appending ");
  para33.createEl('code', { cls: 'vaultquery-help-code', text: "-help" });
  para33.appendText(" to the fence name, such as ");
  para33.createEl('code', { cls: 'vaultquery-help-code', text: "vaultquery-chart-help" });
  para33.appendText(" or ");
  para33.createEl('code', { cls: 'vaultquery-help-code', text: "vaultquery-calendar-help" });
  para33.appendText(".");
  ...
  para34.createEl('code', { cls: 'vaultquery-help-code', text: "vaultquery" });
  para34.appendText(" renders results as an interactive table grid by default.");
  ...
  const code27 = codeBlock33.createEl('code');
  renderPrismCode(code27, "SELECT title, path, modified\nFROM notes\nORDER BY modified DESC\nLIMIT 20;\n\nconfig:\nheight: 320px", "vaultquery");
  ...
  para35.appendText("There are two ways to export query results as markdown tables:");
  ...
  codeBlock34.createSpan({ cls: 'vaultquery-help-fence cm-formatting', text: "```vaultquery-markdown\n" });
  const code28 = codeBlock34.createEl('code');
  renderPrismCode(code28, "SELECT title, path, modified\nFROM notes\nORDER BY modified DESC\nLIMIT 10;", "vaultquery-markdown");
  ...
  codeBlock35.createSpan({ cls: 'vaultquery-help-fence cm-formatting', text: "```vaultquery-markdown\n" });
  const code29 = codeBlock35.createEl('code');
  renderPrismCode(code29, "SELECT title, size\nFROM notes\nORDER BY size DESC\nLIMIT 10;\n\nconfig:\ncolumns: title, size\nalignment: left, right", "vaultquery-markdown");
  ...
  para36.createEl('code', { cls: 'vaultquery-help-code', text: "vaultquery-chart" });
  para36.appendText(" for chart output. Query must use ");
  para36.createEl('code', { cls: 'vaultquery-help-code', text: "label" });
  para36.appendText(" and ");
  para36.createEl('code', { cls: 'vaultquery-help-code', text: "value" });
  para36.appendText(" columns (or ");
  para36.createEl('code', { cls: 'vaultquery-help-code', text: "x" });
  para36.appendText("/");
  para36.createEl('code', { cls: 'vaultquery-help-code', text: "y" });
  para36.appendText(" for scatter). Add a ");
  para36.createEl('code', { cls: 'vaultquery-help-code', text: "series" });
  para36.appendText(" column for multiple datasets.");
  const para37 = container.createEl('p', { cls: 'vaultquery-help-paragraph' });
  para37.appendText("Use a ");
  para37.createEl('code', { cls: 'vaultquery-help-code', text: "vaultquery-chart-help" });
  para37.appendText(" code block for the full chart reference, including result columns, config options, colors, multi-series charts, mixed charts, and examples.");
  ...
  para38.appendText("Use ");
  para38.createEl('code', { cls: 'vaultquery-help-code', text: "vaultquery-calendar" });
  para38.appendText(" for calendar output. Each result row becomes one calendar item. At minimum, the query must return a date column.");
  const para39 = container.createEl('p', { cls: 'vaultquery-help-paragraph' });
  para39.appendText("Use a ");
  para39.createEl('code', { cls: 'vaultquery-help-code', text: "vaultquery-calendar-help" });
  para39.appendText(" code block for the full calendar reference, including result columns, config options, responsive behavior, clickable events, and examples.");
  ...
  para40.appendText("Use ");
  para40.createEl('code', { cls: 'vaultquery-help-code', text: "EXPLAIN QUERY PLAN" });
  para40.appendText(" to inspect how SQLite executes the query:");
  ...
  const code31 = codeBlock37.createEl('code');
  renderPrismCode(code31, "SELECT path, title, status FROM notes_with_properties WHERE status = 'active'", "vaultquery");
  ...
  renderPrismCode(code32, "SELECT n.path, n.title, p.value as status\nFROM notes n\nJOIN properties p ON n.path = p.path AND p.key = 'status'\nWHERE p.value = 'active'", "vaultquery");
  ...
  renderPrismCode(code33, "-- Instead of: WHERE path IN (SELECT path FROM tags WHERE tag_name = '#project')\nSELECT * FROM notes n\nWHERE EXISTS (SELECT 1 FROM tags t WHERE t.path = n.path AND t.tag_name = '#project')", "vaultquery");
  ...
  para43.appendText("Enable JavaScript rendering in settings, then use ");
  para43.createEl('code', { cls: 'vaultquery-help-code', text: "template:" });
  para43.appendText(" after the SQL query (ending with ");
  para43.createEl('code', { cls: 'vaultquery-help-code', text: ";" });
  para43.appendText(") to run JavaScript rendering code.");
  ...
  para44.appendText("Helper functions available via ");
  para44.createEl('code', { cls: 'vaultquery-help-code', text: "h" });
  para44.appendText(":");
  ...
  codeBlock40.createSpan({ cls: 'vaultquery-help-fence cm-formatting', text: "```vaultquery\n" });
  const code34 = codeBlock40.createEl('code');
  renderPrismCode(code34, "SELECT title, path FROM notes LIMIT 5;\ntemplate:\nreturn `<ul>\n  ${results.map(r => `<li>${h.link(r.path, r.title)}</li>`).join('')}\n</ul>`", "vaultquery");
